 ...
 * @version    0.1
 */
class sfResizedFileCompany extends sfValidatedFile
{
  ...
  public function save($file = null, $fileMode = 0666, $create = true, $dirMode = 0777)
  {
    ...
    if ($file[0] != '/' && $file[0] != '\\' && !(strlen($file) > 3 && ctype_alpha($file[0]) && $file[1] == ':' && ($file[2] == '\\' || $file[2] == '/')))
    {
      ...
      $file = $this->path.DIRECTORY_SEPARATOR.'covers'.DIRECTORY_SEPARATOR.$file;
    }
    ...
    $thumbnail = new sfThumbnail(975, 300, true, false, 85, 'sfGDAdapter');
    ...
    $this->savedName = $file;
    return is_null($this->path) ? $file : str_replace($this->path.DIRECTORY_SEPARATOR.'covers'.DIRECTORY_SEPARATOR, '', $file);
  }
public function generateFilename()
{
    return substr ( uniqid ( md5 ( rand ().date('Y-m-d h:i:s') ), true ), 0, 8 ).$this->getExtension($this->getOriginalExtension());
}
}

...
/**
 * CategoryArticleClassification form base class.
 *
 * @method CategoryArticleClassification getObject() Returns the current form's model object
 *
 * @package    getLokal
 * @subpackage form
 * @author     Get Lokal
 ...
 */
abstract class BaseCategoryArticleClassificationForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('category_article_classification[%s]');

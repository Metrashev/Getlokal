 ...
 */
class backendAddReviewGameFilter extends UserProfileFormFilter
{
  public function configure()
  {
   $this->useFields(array('city_id', 'country_id', 'birthdate','gender','created_at'));
	...
	$this->setWidget ( 'week_id', new sfWidgetFormFilterInput ( array ('with_empty' => false ) ) );
	$this->setValidator ( 'week_id', new sfValidatorSchemaFilter ( 'text', new sfValidatorNumber ( array ('required' => false ) ) ) );
    ...
    $this->widgetSchema [ 'status'] = new sfWidgetFormChoice(array('choices' => array( 
	    ...
	    $this->widgetSchema ['review_created_at' ]  = new sfWidgetFormFilterDate(array('from_date' => new sfWidgetFormDateTime(), 'to_date' => new sfWidgetFormDateTime(), 'with_empty' => false));
		$this->setValidator('review_created_at' , new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDateTime(array('required' => false, 'datetime_output' => 'Y-m-d h:i:s')), 'to_date' => new sfValidatorDateTime(array('required' => false, 'datetime_output' => 'Y-m-d h:i:s')))));
...
public function addReviewCreatedAtColumnQuery($query, $field, $value) {
	
			Doctrine::getTable ( 'UserProfile' )->applyReviewCreatedAtFilter ( $query, $value );
	
	}
	
public function addWeekIdColumnQuery($query, $field, $value) {
		if ($value ['text'] != null) {
			Doctrine::getTable ( 'UserProfile' )->applyWeekIdFilter ( $query, $value );
		}
	}
	...
	public function getFields() {
		...
		$fields ['review_created_at'] = 'company_created_at';

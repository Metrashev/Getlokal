...
class sfFormField
{
  ...
  /**
   * Sets the error for this field.
   *
   * @param sfValidatorError $error      The Error that will be displayed when (sfFormField)->renderError()
   */
  public function setError(sfValidatorError $error)
  {
    $this->error = $error;
  }

...
class sfWebRequest extends sfRequest
{
  ...
  public function getPathInfo()
  {
   ...
   if(isset($pathArray['REQUEST_URI'])){
      ...
      if(strpos($pathArray['REQUEST_URI'], ' ') !== false || strpos($pathArray['REQUEST_URI'], '+') !== false 
      && strpos($pathArray['REQUEST_URI'], 'backend') === false && strpos($pathArray['REQUEST_URI'], 'cubes') === false){

      $old = array(" ", "+");
      $new = array("-", "-");

      $pathInfo = str_replace($old, $new, $pathInfo);

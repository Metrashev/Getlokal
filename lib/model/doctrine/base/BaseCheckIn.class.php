 ...
 * @method CheckIn setCompanyId()  Sets the current record's "company_id" value
 * @method CheckIn setLatitude()   Sets the current record's "latitude" value
 * @method CheckIn setLongitude()  Sets the current record's "longitude" value
 * @method CheckIn setCompany()    Sets the current record's "Company" value
 * 
 * @package    getLokal
 * @subpackage model
 * @author     Get Lokal

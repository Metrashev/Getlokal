...
class ImageManipulator
{
    ...
    public function crop($x1, $y1 = 0, $x2 = 0, $y2 = 0)
    {
        ...
        imagecopy($new_image, $this->image, 0, 0, $x1, $y1, $width, $height);
       
        
        
        $temp = imagecreatetruecolor ( 975, 300 ) or die ( "Cannot Initialize new GD image stream" );
		imagecopy ($temp, $new_image, (975 - $width) / 2, (300 - $height) / 2, 0, 0, $width, $height );
        ...
        public function cropOfferImage($x1, $y1 = 0, $x2 = 0, $y2 = 0)
        {
            if (!is_resource($this->image)) {
                throw new RuntimeException('No image set');
            }
            ...
            imagecopyresampled($new_image, $this->image, 0, 0, $x1, $y1, $nw, $nh, $width, $height);

            return $this->_replace($new_image);
        }

...
/*CropTool*/
    ...
    $('.input_submit').click(function(){
        ...
        if((fileInput.val() === '') && currentImage.length ===0){
            ...
            $('html, body').animate({
                scrollTop: $("#company_offer_max_vouchers").offset().top - 60
            }, 1000);
            return false; 
...
function offerDatepickers(offerMaxEndDate, voucherMinDate, dealActiveTo, sCulture, str){
    ...
    $( "#company_offer_active_from" ).change(function() {
        //  $("a.endDate").hide();
    ...
    $( "#company_offer_active_to" ).change(function() {
    ...
    $( "#company_offer_valid_from" ).change(function() {
        $(this).parent().removeClass('form_label_inlineerror');
        $(this).parent().addClass('form_label_inline');
        $(this).next().remove();
    });
    $( "#company_offer_valid_to" ).change(function() {
        $(this).parent().removeClass('form_label_inlineerror');
        $(this).parent().addClass('form_label_inline');
        $(this).next().remove();
    });

...
Sa zadovoljstvom želimo dobrodoščicu mestu/firmi <?php echo $company->getCompanyTitleByCulture('me');?> na najveću socijalnu mrežu za firme u Crnoj Gori! 
<br><br>
Kako biste najbolje iskoristili ono što Vam naš sajt nudi kliknite <a href="<?php echo $path?>"><?php echo 'ovdje';?></a> ( <?php echo $path?> ) i iskoristite <?php echo $pageAdmin->getUserProfile()->getsfGuardUser()->getEmailAddress();?>  i Vašu lozinku kako biste se ulogovali. <br><br>
Kada se ulogujete, registrujte korisničko ime i lozinku za mesto/firmu i ažurirajte podatke o njoj – opis mesta/firme, pictures, radno vrijeme, kontakt informacije.<br> <br>

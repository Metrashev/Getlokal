...
<?php $path = link_to_frontend('placeadmin_activate', array('key'=>$user->getUserProfile()->getHash()));?>
...
<br><br>Одкако ќе влезете, најавете се на профилот на местото и потоа ажурирајте ги информациите за истото – опис, класификации, слики, работно време, информации за локација и контакт.
...
It is our pleasure to welcome <?php echo $company->getCompanyTitle('en');?> on joining the largest social network for places and businesses in Macedonia! 
<br><br>

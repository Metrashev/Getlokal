...
<br><br>
A honlapunk által nyújtott előnyök legjobb kihasználásához, kattintson <a href="<?php echo $path?>"><?php echo 'ide';?></a> és <?php echo $pageAdmin->getUserProfile()->getsfGuardUser()->getEmailAddress();?> e-mail és a jelszava segítségével lépjen be a profiljába.
<br><br>Ha a kapsolat nem aktiv, másolja le és illessze be a címsorba:
<br><?php echo $path ;?>
...
<br><br>Hogy megnézhesse hogyan néz ki egy helyoldal, kattintson <a href="<?php echo $path_business?>"><?php echo 'ide' ;?></a>-ra.
<br><br>
Ha bármilyen kérdése lenne, lépjen kapcsolatba velünk<a href="mailto:hungary@getlokal.com">hungary@getlokal.com</a>.<br>-on.
Ügyvözöljük,<br>

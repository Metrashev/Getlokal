...
<br><?php echo $path ;?>
<br><br>Вече в профила си, влезте в профила на мястото, което представлявате и актуализирайте неговата информация – бизнес описание, снимки, работно време, данни за контакт.

...
<br><br>
Kako biste najbolje iskoristili ono što Vam naš sajt nudi kliknite <a href="<?php echo $path?>"><?php echo 'ovde';?></a> ( <?php echo $path?> ) i iskoristite <?php echo $pageAdmin->getUserProfile()->getsfGuardUser()->getEmailAddress();?>  i Vašu lozinku kako biste se ulogovali. <br><br>

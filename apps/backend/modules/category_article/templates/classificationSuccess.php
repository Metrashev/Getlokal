<form action="<?php echo url_for('category_article/classification?id='. $category->getId() ) ?>" method="post">
  
  <div class="wrap">
    <h2><?php echo $category->getTitle() ?> (<?php echo link_to('Category', 'category_article/classification?id='.$category->getId()) ?>)</h2>
...
$(document).ready(function() {
  $('#category_article_sector').change(function() {

	$('#for_check').removeAttr('checked');
	
	$.ajax({
	    url: "<?php echo url_for('category_article/addClassification');?>" ,

...
<h2>NO OFFER Package <?php echo $company ?> (<?php echo link_to('back', 'company/index') ?>)</h2>
...
<?php if($sf_user->hasFlash('notice')): ?>
  ...
  <?php endif; ?>
  <form action="<?php echo url_for('company/packageNOOffer') ?>?id=<?php echo $company->getId() ?>" method="post" >
    ...
    <table class="form-table">
      <tbody>
       <tr class="form-field form-required">
          ...
          <td>Package Includes: TOP_IN_SEARCH, DETAIL_DESCRIPTION,

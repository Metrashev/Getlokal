...
<br><br>
Az igényük <?php echo $company->getCompanyTitleByCulture('hu');?>-nak a csatlakozására Önök bizniszprofiljához <a href="http://www.getlokal.hu">www.getlokal.hu-ban</a> vissza volt utasítva, mert probléma lépett fel. 
<br><br>
...
<br><br>
Kérjük lépjenek be újra a bizniszprofiljukba és ellenőrizzenek újból minden elérhetőséget  mielőtt hozzádnák  <?php echo $company->getCompanyTitleByCulture('hu');?> újra. 
...
<br><br>
Dear <?php echo ($pageAdmin->getUserProfile()->getGender() == 'f')? ' Mrs': (($pageAdmin->getUserProfile()->getGender() == 'm')? ' Mr': '');?> <?php  if ($pageAdmin->getUserProfile()->getGender()): echo (($pageAdmin->getUserProfile()->getLastName())? $pageAdmin->getUserProfile()->getLastName():$pageAdmin->getUserProfile()->getFirstName()) ; endif;?>,<br><br>

Your application for claiming <?php echo $company->getCompanyTitleByCulture('en');?> in <a href="http://www.getlokal.hu/en">www.getlokal.hu</a> has been rejected as there was a problem with it. <br><br>

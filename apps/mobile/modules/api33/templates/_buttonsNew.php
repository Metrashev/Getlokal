<div class="buttons clearfix">
    ...
    <?php 
        $fav_text = $is_favorite ? __("Unsave") : __("Save");
    ?>
    <a href="getlokal://favorite" class="follow col-xs-6 <?php echo $is_favorite ? 'active' : ''; ?>">
        <div class="inner">
	        <i class="icon"></i>
	        <span data-follow-text="<?php echo __('Save'); ?>" data-unfollow-text="<?php echo __('Unsave') ?>">
                <?php echo $is_favorite ? __('Unsave') : __('Save'); ?>
            </span>
        </div>
    </a>
    <?php 

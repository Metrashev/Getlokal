...
class api31Actions extends sfActions {
    private
        ...
        if (count($companiyIds)) {
            ...
            foreach ($companies as $company) {
                ...
                $items[] = array(
                    ...
                    'content_url' => $this->generateUrl('default', array('module' => 'api31', 'action' => 'company', 'id' => $company->getId(), 'token' => $request->getParameter('token'), 'locale' => $culture), true),
        ...
        if ($countResult) {
            ...
            foreach ($query as $c) {
                ...
                $items[] = array(
                    ...
                    'content_url' => $this->generateUrl('default', array('module' => 'api31', 'action' => 'company', 'id' => $c->getId(), 'token' => $request->getParameter('token'), 'locale' => $culture), true),
    ...
    private function __formatOffer($o, $kms = null, $single_place = false)
    {
        ...
        $data = array(
            ...
            'content_url' => $contentUrl,
            'share_url' => 'http://www.getlokal.' . $this->getUser()->getDomain($culture) . '/' .
        ...
        $place = array(
            ...
            'share_url' => 'http://www.getlokal.' . $this->getUser()->getDomain($culture) . '/' . $this->getUser()->getCulture() . '/' . $company->getCity()->getSlug() . '/' . $company->getSlug(),
            'content_url' => $this->generateUrl('default', array(
                'module' => 'api31',
                'action' => 'company',
            ), true) . '?' . http_build_query(array(

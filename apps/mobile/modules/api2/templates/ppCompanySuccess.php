        ...
        <div class="company">
            <div class="content_area">
                <div class="image pp_company_header">
                    ...
                    <h2 class="title_pp"><?php echo $company->getCompanyTitleByCulture($sf_user->getCulture()); ?></h2>
...
*/ ?>
        ...
        //FOLLOW & UNFOLLOW
        $('.function_tabs ul li#follow').on('tap', function (e) {
            //e.preventDefault();
            $button = $(this);
        ...
        //CHECK IN
        $('.function_tabs  ul li#checkin').on('tap', function (e) {
            //e.preventDefault();
            $button = $(this);
            if ($button.hasClass('tapped')) {
                //$button.removeClass('tapped');

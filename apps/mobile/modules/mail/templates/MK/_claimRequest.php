...
<?php echo link_to('log into you profile','userSettings/companySettings?sf_culture=en', true)?>, кликнете на Мои места, одберете го местото и кликнете на опцијата Администратори од левото мени.<br><br>
<ul>

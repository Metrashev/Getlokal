<div class="desc_img_wrap">
    <?php echo link_to(
        image_tag($company->getThumb(), 'size=50x50 alt='. $company->getCompanyTitle()),
...
<div class="details">
    ...
    <span class="classification"><?php echo link_to(
   ...
   <div class="stars-holder small map-overlay-wrapper-stars">     
    ...
    <?php if ($company->getPhone()): ?>
        <div class="phone"><i class="fa fa-phone"></i><?php echo $company->getPhoneFormated() ?></div>
    <?php endif ?>
</div>
<div class="clear"></div>

...
<?php echo link_to('влезте във вашия профил','userSettings/companySettings', array('absolute'=>true))?>, Изберете опцията Моите места, логнете се в профила на сътветното място и изберете опцията Администратори от менюто вляво.<br><br>
<ul>

...
<?php if ($count == 1):?>
Твојот купон за понудата <?php echo $company_offer->getTitle('bg');?> е успешно издаден.
<br><br>
За да го видиш, кликни

<?php echo link_to('тука', 'profile/vouchers',array('absolute' => true));?>. Доколку линкот не е активен, можеш да го ископираш и поставиш во полето за адреса во пребарувачот.
<?php elseif($count > 1):?>
Твоите купони за понудата <?php echo $company_offer->getTitle('bg');?> се успешно издадени.
<br><br>
...
<?php endif;?> Во случај да не си логиран/а, логирај се и потоа отиди во 'Купони'.<br>
Ако имаш било какво прашање, слободно пиши ни на <a href="mailto:macedonia@getlokal.com">macedonia@getlokal.com</a>.<br><br>

		...
		<div class="winner_content">
			<?php if (isset($games) && count($games)) : ?>
			    ...
			    <?php foreach ($games as $game) : ?>
			        ...
			        <?php if ($iterations == 1) : ?>
			        	<div class="step1">
				        	<img src="/images/facebook/prizes/mk/game_<?php echo $game->getId() ?>_prize_big_award.png" />
		    				<div class="left_wrap">
					            <h1>
					            	<span>СПЕЧЕЛИЛ</span>
			        ...
			        <?php else : ?>
			            ...
			            <div class="small_results">
                                        <img src="/images/facebook/prizes/mk/game_<?php echo $game->getId() ?>_prize_old.png" />

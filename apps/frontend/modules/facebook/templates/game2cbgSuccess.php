...
<?php slot("fb_meta") ?>
    ...
    <meta property="og:url" content="<?php echo url_for('default', array('module' => 'facebook', 'action' => 'game2cbg'), true); ?>" />
        	...
        	<div class="content_in">
                ...
                <div class="right_wrap">
                	<?php if ($isFbGame): ?>
                        ...
                        <div class="play_again">
                            <a href="<?php echo url_for('facebook/game2cbg') ?>" class="button">Играй отново и спечели</a>
...
$(document).ready(function() {
    ...
    $('.slide .continue').click(function () {
        if (_step == 2) {
            ...
            $.post('<?php echo url_for('default', array('module' => 'facebook', 'action' => 'game2cbg'), true) ?>', { save: true, review_place: $('input[name="reivew_place"]').val(), review_stars: $("input.star:checked").val(), review_text: $('textarea[name="review"]').val(), genre: $('input[name="genre"]:checked').val() }, function(data) {
                if (data) {
                    if (data.error != undefined && data.error == true) {
                        location.href = '<?php echo url_for('facebook/game2cbg'); ?>';
                    }
...
*/ ?>
    ...
    $('a.share').live('click', function() {
        var obj = {
            method: 'feed',
            link: 'http://apps.facebook.com/pop-folk-vs-others',

...
<?php //use_javascripts_for_form($form) ?>
 ...
 <?php if($sf_user->getFlash('newerror')):?>   
   ...
   <?php endif;?>
<form id="listForm" action="<?php echo url_for('list/addToNew?company_id='.$company->getId()) ?>" method="post" <?php $form->isMultipart() and print 'enctype="multipart/form-data" ' ?>>
    ...
    <div class="content_in">
		...
		<div class="form_box">
			<div class="list_of_places" id="list_of_places">
				...
				<?php include_partial('list/place_add_to_new', array('company'=>$company,'culture'=>$sf_user->getCulture(), 'is_place_admin_logged'=>$is_place_admin_logged) );?>
			</div>
			<div class="clear"></div>
			<input type="hidden" value="<?php echo $company->getCompanyPage()->getId() ?>" name="list[company_page]" />
		</div>
		<div class="form_box">

...
<?php slot('no_map', true) ?>
 <div class="settings_content">
  ...
  <form action="<?php echo url_for('companySettings/findMyCompany')?>" method="post">
  ...
  <?php echo sprintf(__('Click %s to add new company.', null, 'company'),link_to(__('here', null, 'user'), 'company/addNewCompany'));?>
  <?php endif;?>
  </div>

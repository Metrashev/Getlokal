 ...
 */
class placeAdminValidatorUser extends sfValidatorBase
{
  public function configure($options = array(), $messages = array())
  {
    ...
    $this->setMessage('invalid', 'The email and/or password are invalid');
  }
  ...
  protected function doClean($values)
  {
    ...
    { 
       if ($callable = sfConfig::get('app_sf_guard_plugin_retrieve_by_username_callable'))
       {
           ...
           $user = $this->getTable()->findOneByEmailAddress($username);
       }
        // user exists?
